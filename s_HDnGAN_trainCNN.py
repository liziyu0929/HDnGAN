...
#
#   Reference:
#   [1] Li, Z., Tian, Q., Ngamsombat, C., Cartmell, S., Conklin, J., Filho, A. L. M. G., ... & Huang, S. Y. (2021). 
#       High‐fidelity fast volumetric brain MRI using synergistic wave‐controlled aliasing in parallel imaging and a 
#       hybrid denoising generative adversarial network (HDnGAN). Medical physics. https://doi.org/10.1002/mp.15427
#
